...
CHANNEL__NEKO_DUNGEON__LOG_MENTION = ChannelText.precreate(828552266374053889)
CHANNEL__NEKO_DUNGEON__LOG_EMOJI = ChannelText.precreate(864748017726259210)
...
ROLE__NEKO_DUNGEON__NSFW_ACCESS = Role.precreate(828576094776590377)
