...
async def _help_voice(client,message):
    ...
    text=(
        ...
        'you are. You can join me with a set % volume too.\n'
        ...
        f'- `{prefix}voice resume` : Resume my player.\n'
        f'- `{prefix}voice skips` : Skips the actual source.\n'
        f'- `{prefix}voice stop` : Stops my player and clear the queue.\n'
        ...
        'local collection. If nohing is passed, I ll tell you, what I am '
        'currently playing.\n'
