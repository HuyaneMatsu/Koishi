...
from .embed_builder_select import (
    select_response_embed_builder_emoji, select_response_embed_builder_reaction, select_response_embed_builder_sticker
)
...
async def snipe_interaction_select_emoji(client, event):
    """
    Switches the embed to the selected emoji.
    ...
    response : ``Embed``
    """
    return await select_response_embed_builder_emoji(client, event)
...
async def snipe_interaction_select_reaction(client, event):
    """
    Switches the embed to the selected reaction.
    ...
    response : ``Embed``
    """
    return await select_response_embed_builder_reaction(client, event)
...
async def snipe_interaction_select_stickers(client, event):
    """
    Switches the embed to the selected sticker.
    ...
    response : ``Embed``
    """
    return await select_response_embed_builder_sticker(client, event)
