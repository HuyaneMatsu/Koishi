...
from ..filtering import get_image_detail_tags


def test__get_image_detail_tags():
    """
    ...
    output = get_image_detail_tags(ACTIONS)
    vampytest.assert_instance(output, set)
    vampytest.assert_eq(output, {ACTION_TAG_FEED, ACTION_TAG_KISS})
