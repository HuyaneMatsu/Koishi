...
from ..rendering import _produce_action_internal
...
def test__produce_action_internal(action_tag, source_character, target_character):
    """
    Tests whether ``_produce_action_internal`` works as intended.
    ...
    output : `str`
    """
    output = [*_produce_action_internal(action_tag, source_character, target_character)]
