...
CHANNEL__SUPPORT__LOG_ERROR = Channel.precreate(1135297184498204883)
CHANNEL__SUPPORT__LOG_DISPATCH = Channel.precreate(1135297242765459517)
...
CHANNEL__SUPPORT__LOG_STICKER = Channel.precreate(1135298535500284024)
