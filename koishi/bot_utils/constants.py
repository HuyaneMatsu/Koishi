...
ROLE__SUPPORT__ELEVATED = Role.precreate(403586901803794432, guild_id = GUILD__SUPPORT.id, name = 'Orin\'s workcarrier')
ROLE__SUPPORT__BOOSTER = Role.precreate(585556522558554113, guild_id = GUILD__SUPPORT.id, name = 'Koishi Lover')
...
ROLE__SUPPORT__POLLS = Role.precreate(1308335756191858708)
ROLE__SUPPORT__BOT_ACCESS__KOISHI__DEFAULT = Role.precreate(1340630808221974629)
ROLE__SUPPORT__BOT_ACCESS__ALICE = Role.precreate(1340297474031747142)
ROLE__SUPPORT__BOT_ACCESS__FLANDRE = Role.precreate(1340297916216250433)
ROLE__SUPPORT__BOT_ACCESS__KOISHI = Role.precreate(1340297629388505181)
ROLE__SUPPORT__BOT_ACCESS__NUE = Role.precreate(1348269128699351140)
ROLE__SUPPORT__BOT_ACCESS__ORIN = Role.precreate(1340297696560287784)
ROLE__SUPPORT__BOT_ACCESS__TOY_KOISHI = Role.precreate(1340297875082580049)
ROLE__SUPPORT__BOT_ACCESS__YOSHIKA = Role.precreate(1340297852970074153)
...
URL__KOISHI_TOP_GG = f'https://discordbots.org/bot/{config.KOISHI_ID}/vote'
...
RELATIONSHIP_VALUE_DEFAULT = 500
