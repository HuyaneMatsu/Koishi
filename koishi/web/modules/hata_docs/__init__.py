...
set_highlight_html_class(HIGHLIGHT_TOKEN_TYPES.TOKEN_TYPE_STRING_FORMAT_MARK, 'c_py_format_string_mark')
set_highlight_html_class(HIGHLIGHT_TOKEN_TYPES.TOKEN_TYPE_COMMENT, 'c_py_comment')
set_highlight_html_class(HIGHLIGHT_TOKEN_TYPES.TOKEN_TYPE_STRING_FORMAT_CODE, 'c_py_format_string_code')
set_highlight_html_class(HIGHLIGHT_TOKEN_TYPES.TOKEN_TYPE_STRING_FORMAT_POSTFIX, 'c_py_format_string_postfix')
