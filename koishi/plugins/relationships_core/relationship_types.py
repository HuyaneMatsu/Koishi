__all__ = (
    'RELATIONSHIP_TYPE_AUNTIE', 'RELATIONSHIP_TYPE_CO_WORKER', 'RELATIONSHIP_TYPE_DAUGHTER', 
...
RELATIONSHIP_TYPE_AUNTIE = 10
RELATIONSHIP_TYPE_NIECE = 11
RELATIONSHIP_TYPE_CO_WORKER = 12
RELATIONSHIP_TYPE_GRANNY = 13
RELATIONSHIP_TYPE_GRANDDAUGHTER = 14
RELATIONSHIP_TYPE_YOUNG_MISTRESS = 15
RELATIONSHIP_TYPE_NANNY = 16
RELATIONSHIP_TYPE_TEA_FRIEND = 17
...
RELATIONSHIP_TYPE_NAMES = {
    ...
    RELATIONSHIP_TYPE_AUNTIE: 'auntie',
    RELATIONSHIP_TYPE_NIECE: 'niece',
    RELATIONSHIP_TYPE_CO_WORKER: 'co-worker',
    RELATIONSHIP_TYPE_GRANNY : 'granny',
    RELATIONSHIP_TYPE_GRANDDAUGHTER :  'granddaughter',
    RELATIONSHIP_TYPE_YOUNG_MISTRESS : 'young mistress',
    RELATIONSHIP_TYPE_NANNY : 'nanny',
    RELATIONSHIP_TYPE_TEA_FRIEND : 'tea friend',
}
