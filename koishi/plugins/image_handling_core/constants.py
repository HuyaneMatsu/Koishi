__all__ = ('CHARACTER_DIRECTION_ANY', 'CHARACTER_DIRECTION_SOURCE', 'CHARACTER_DIRECTION_TARGET')
...
CHARACTER_DIRECTION_SOURCE = 1
CHARACTER_DIRECTION_TARGET = 2
CHARACTER_DIRECTION_ANY = CHARACTER_DIRECTION_SOURCE | CHARACTER_DIRECTION_TARGET
