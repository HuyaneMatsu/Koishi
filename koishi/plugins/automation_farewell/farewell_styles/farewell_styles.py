...
FAREWELL_STYLES_BY_CLIENT_ID = {
    config.FLANDRE_ID: FAREWELL_STYLE_FLANDRE,
    config.KOISHI_ID: FAREWELL_STYLE_KOISHI,
    config.ORIN_ID: FAREWELL_STYLE_ORIN,
    config.YOSHIKA_ID: FAREWELL_STYLE_YOSHIKA,
}
