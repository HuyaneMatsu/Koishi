...
def _iter_options():
    ...
    yield OPTION_PROPOSAL, False, False, 'You were already **not** receiving proposal notifications.'
    

@vampytest._(vampytest.call_from(_iter_options()).returning_last())
def test__build_notification_settings_change_description(option, value, changed):
    """
    Tests whether ``build_notification_settings_change_description`` works as intended.
    ...
    output : `str`
    """
    return build_notification_settings_change_description(option, value, changed)
