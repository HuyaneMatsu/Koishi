...
from ..utils import get_notifier_client


def test__get_notifier_client__notifier_client_set():
    """
    Tests whether ``get_notifier_client`` works as intended.
    ...
    notification_settings = NotificationSettings(
        user_id,
        notifier_client_id = client_id_0,
    )
    
    try:
        output = get_notifier_client(user, notification_settings.notifier_client_id, None)
...
def test__get_notifier_client__default_client_given():
    """
    Tests whether ``get_notifier_client`` works as intended.
    ...
    try:
        output = get_notifier_client(user, notification_settings.notifier_client_id, client_0)
...
def test__get_notifier_client__available_clients():
    """
    Tests whether ``get_notifier_client`` works as intended.
    ...
    mocked = vampytest.mock_globals(get_notifier_client, 2, FEATURE_CLIENTS = FEATURE_CLIENTS)
    
    try:
        output = mocked(user, notification_settings, None)
...
def test__get_notifier_client__main_client():
    """
    Tests whether ``get_notifier_client`` works as intended.
    ...
    mocked = vampytest.mock_globals(get_notifier_client, MAIN_CLIENT = client_0)
