__all__ = (
    ...
    'HANIYASUSHIN_KEIKI',
    'HATA_NO_KOKORO', 'HEARN_MARIBEL', 'HEI_MEILING', 'HIEDA_NO_AKYUU', 'HIJIRI_BYAKUREN',
    ...
    'KUMOI_ICHIRIN', 'KURODANI_YAMAME', 'KUROKOMA_SAKI', 'KURUMI', 'LABEL', 'LAPISLAZULI_HECATIA', 'LETTY_WHITEROCK',
    'LORELEI_MYSTIA', 'LILY_BLACK',
...
LAPISLAZULI_HECATIA = TouhouCharacter(
    'lapislazuli_hecatia',
    'Lapislazuli Hecatia',
    (
        'ラピスラズリ ヘカーティア',
        'Rapisurazuri Hekaatia',
        'Hecatia',
        'Hecatia Lapislazuli',
        'Hekaatia',
    ),
