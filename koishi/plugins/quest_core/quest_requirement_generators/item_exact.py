__all__ = ('QuestRequirementGeneratorItemExact',)
...
class QuestRequirementGeneratorItemExact(QuestRequirementGeneratorBase):
    """
    Represents an exact item requirement generator.
    ...
    def __new__(
        ...
        """
        Creates a new quest exact item requirement generator.
    ...
    def generate(self, random_number_generator):
        ...
        return (
            QuestRequirementInstantiableItemExact(self.item_id, self.amount_type, amount),
            diversion,
        )
