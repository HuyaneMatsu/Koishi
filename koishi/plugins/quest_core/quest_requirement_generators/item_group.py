__all__ = ('QuestRequirementGeneratorItemGroup',)
...
class QuestRequirementGeneratorItemGroup(QuestRequirementGeneratorBase):
    """
    Represents an group item requirement generator.
    ...
    __slots__ = (
        ...
        'amount_variance_percentage_upper_threshold', 'item_group_id'
    )
    ...
    def __new__(
        ...
        """
        Creates a new quest group item requirement generator.
    ...
    def generate(self, random_number_generator):
        ...
        return (
            QuestRequirementInstantiableItemGroup(self.item_group_id, self.amount_type, amount),
            diversion,
        )
