...
from ..checks import check_has_role_other


def _iter_options__passing():
    role_id = 202502140010
    guild_id = 202502140011
    user_id = 202502140012
...
def _iter_options__failing():
    role_id = 202502140013
    guild_id = 202502140014
...
def test__check_has_role_other(role, user, guild_id, cache):
    """
    Tests whether ``check_has_role_other`` works as intended.
    ...
    """
    check_has_role_other(role, user, guild_id)
