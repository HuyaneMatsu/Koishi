...
from ..content_builders import build_linked_quest_detailed_description
...
def _iter_options():
    ...
    yield (
        ...
        1,
        (
            f'**Task: Submit 0 / 20 Peach {BUILTIN_EMOJIS["peach"]} to Mystia.**\n'
            f'\n'
...
def test__build_linked_quest_detailed_description(linked_quest, quest_template, user_level):
    """
    Tests whether ``build_linked_quest_detailed_description`` works as intended.
    ...
    output : `str`
    """
    output = build_linked_quest_detailed_description(linked_quest, quest_template, user_level)
