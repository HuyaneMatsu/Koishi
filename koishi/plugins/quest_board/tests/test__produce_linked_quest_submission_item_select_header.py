...
from ..content_building import produce_linked_quest_submission_item_select_header
...
def test__produce_linked_quest_submission_item_select_header(
    ...
    output : `str`
    """
    output = [*produce_linked_quest_submission_item_select_header(
        submission_requirement_normalised, accumulated_amount, accumulated_weight, accumulated_value
    )]
