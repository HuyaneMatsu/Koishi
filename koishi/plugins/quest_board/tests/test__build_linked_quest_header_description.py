...
from ..content_builders import build_linked_quest_header_description
...
def test__build_linked_quest_header_description(user_id, user_name, guild_id, user_nick, adventurer_info, quest_count):
    """
    Tests whether ``build_linked_quest_header_description`` works as intended.
    ...
    output = build_linked_quest_header_description(user, guild_id, adventurer_info, quest_count)
