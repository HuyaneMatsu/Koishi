...
from ..content_builders import build_linked_quest_submit_success_completed_description
...
def test__build_linked_quest_submit_success_completed_description(
    item, amount_type, amount_required, amount_used, reward_balance, reward_credibility,
):
    """
    Tests whether ``build_linked_quest_submit_success_completed_description`` works as intended.
    ...
    output : `str`
    """
    output = build_linked_quest_submit_success_completed_description(
        item, amount_type, amount_required, amount_used, reward_balance, reward_credibility,
    )
