...
from ..content_builders import produce_linked_quest_submit_success_n_left_description
...
def test__produce_linked_quest_submit_success_n_left_description(
    item, amount_type, amount_submitted, amount_required, amount_used,
):
    """
    Tests whether ``produce_linked_quest_submit_success_n_left_description`` works as intended.
    ...
    output : `str`
    """
    output = [*produce_linked_quest_submit_success_n_left_description(
        item, amount_type, amount_submitted, amount_required, amount_used,
    )]
