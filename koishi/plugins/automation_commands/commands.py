...
try:
    ...
    AUTOMATION_FAREWELL_AVAILABLE = False

else:
    AUTOMATION_FAREWELL_AVAILABLE = True
...
try:
    ...
    AUTOMATION_REACTION_COPY_AVAILABLE = False

else:
    AUTOMATION_REACTION_COPY_AVAILABLE = True


try:
    from ..automation_reaction_role import (
        command_automation_reaction_role_entry_create, command_automation_reaction_role_entry_list
    )
except ImportError:
    if not MARISA_MODE:
        raise
    
    AUTOMATION_REACTION_ROLE_AVAILABLE = False

else:
    AUTOMATION_REACTION_ROLE_AVAILABLE = True
...
try:
    ...
    AUTOMATION_TOUHOU_FEED_AVAILABLE = False

else:
    AUTOMATION_TOUHOU_FEED_AVAILABLE = True
...
try:
    ...
    AUTOMATION_WELCOME_AVAILABLE = False

else:
    AUTOMATION_WELCOME_AVAILABLE = True
...
async def disable_all(
    ...
    # Disable touhou-feed
    if AUTOMATION_TOUHOU_FEED_AVAILABLE:
...
if AUTOMATION_FAREWELL_AVAILABLE:
...
if AUTOMATION_REACTION_COPY_AVAILABLE:
...
if AUTOMATION_REACTION_ROLE_AVAILABLE:
    AUTOMATION_REACTION_ROLE_COMMANDS = AUTOMATION_COMMANDS.interactions(
        None,
        name = 'reaction-role',
        description = 'Give out or take away roles automatically with reactions.',
    )
    
    AUTOMATION_REACTION_ROLE_COMMANDS.interactions(
        command_automation_reaction_role_entry_create,
        name = 'new',
    )
    
    AUTOMATION_REACTION_ROLE_COMMANDS.interactions(
        command_automation_reaction_role_entry_list,
        name = 'list',
    )
...
if AUTOMATION_WELCOME_AVAILABLE:
