...
from ..queries import get_market_place_item_listing_own_offers


def _iter_options():
    now = DateTime(2016, 5, 14, tzinfo = TimeZone.utc)
    
    user_id_0 = 202512230000
    user_id_1 = 202512230001
    user_id_2 = 202512230002
...
async def test__get_market_place_item_listing_own_offers(
    user_id, now, page_index, page_size, market_place_items_patched, market_place_items_cache_patched
):
    """
    Tests whether ``get_market_place_item_listing_own_offers`` works as intended.
