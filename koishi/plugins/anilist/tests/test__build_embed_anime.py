...
from ..embed_building_media import build_embed_anime
from ..keys import (
    KEY_MEDIA, KEY_MEDIA_EPISODE_COUNT, KEY_MEDIA_STATUS, KEY_MEDIA_IMAGE, KEY_MEDIA_DESCRIPTION,
    KEY_MEDIA_EPISODE_LENGTH, KEY_MEDIA_IMAGE_LARGE, KEY_MEDIA_FORMAT, KEY_FUZZY_DATE_DAY,
    KEY_MEDIA_ID, KEY_MEDIA_NAME, KEY_MEDIA_NAME_ROMAJI, KEY_MEDIA_START_DATE, KEY_FUZZY_DATE_MONTH,
    KEY_FUZZY_DATE_YEAR, KEY_MEDIA_AVERAGE_SCORE
)
...
def test__build_embed_anime(data):
    """
    Tests whether ``build_embed_anime`` works as intended.
