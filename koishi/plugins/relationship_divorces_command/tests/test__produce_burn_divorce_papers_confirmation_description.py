...
def test__produce_burn_divorce_papers_confirmation_description(
    ...
    """
    Tests whether ``produce_burn_divorce_papers_confirmation_description`` works as intended.
    ...
    output : `str`
    """
    output = [*produce_burn_divorce_papers_confirmation_description(
        relationship_divorces,
        required_balance,
        target_user,
        guild_id,
