...
from ..utils import set_stat_value_for_index
...
def test__set_stat_value_for_index(user_id, getter_function, stat_index, value):
    """
    Tests whether ``set_stat_value_for_index`` works as intended.
    ...
    set_stat_value_for_index(stats, stat_index, value)
