...
def _iter_options():
    ...
    yield (
        ...
        Embed(
            ...
            (
                'You do not have enough available hearts to buy more relationship slots for Keine.\n'
    ...
    yield (
        ...
        Embed(
            'Insufficient balance',
            (
                'You do not have enough available hearts to buy more relationship slots for Caver.\n'
                f'You need 2000 {EMOJI__HEART_CURRENCY} to buy the 3rd slot.'
            ),
        ),
    )
