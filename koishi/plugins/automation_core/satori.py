__all__ = (
    'clear_satori_channel', 'clear_satori_channels', 'discover_satori_channel', 'discover_satori_channels',
    'get_watcher_channels_for', 'remove_watcher_channel', 'reset_satori_channels', 'set_satori_channel'
)
