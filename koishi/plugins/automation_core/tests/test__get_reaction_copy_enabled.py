...
from ..operations import get_reaction_copy_enabled
from ..constants import AUTOMATION_CONFIGURATIONS


def _iter_options():
    guild_id = 202405300063
...
def test__get_reaction_copy_enabled(automation_configuration, guild_id, extras):
    """
    Tests whether ``get_reaction_copy_enabled`` works as intended.
    ...
    try:
        ...
        output = get_reaction_copy_enabled(guild_id)
