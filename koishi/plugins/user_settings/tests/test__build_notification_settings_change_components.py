...
from ..component_building import build_notification_settings_change_components
...
def test__build_notification_settings_change_components(option, value, changed):
    """
    Tests whether ``build_notification_settings_change_components`` works as intended.
    ...
    """
    output = build_notification_settings_change_components(option, value, changed)
