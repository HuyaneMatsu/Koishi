...
from ..component_building import build_preferred_client_change_components
...
def test__build_preferred_client_change_components(client, guild_id, value, changed):
    """
    Tests whether ``build_preferred_client_change_components`` works as intended.
    ...
    """
    output = build_preferred_client_change_components(client, guild_id, value, changed)
