...
from ..content_building import produce_preferred_client_change_description
...
def test__produce_preferred_client_change_description(client, guild_id, value, changed):
    """
    Tests whether ``produce_preferred_client_change_description`` works as intended.
    ...
    output : `str`
    """
    output = [*produce_preferred_client_change_description(client, guild_id, value, changed)]
