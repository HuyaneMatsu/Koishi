...
from ..utils import get_user_settings_preferred_client
...
def test__get_user_settings_preferred_client__no_input():
    """
    Tests whether ``get_user_settings_preferred_client`` works as intended.
    ...
    output = get_user_settings_preferred_client(event, '')
...
def test__get_user_settings_preferred_client__default():
    """
    Tests whether ``get_user_settings_preferred_client`` works as intended.
    ...
    output = get_user_settings_preferred_client(event, 'un')
...
def test__get_user_settings_preferred_client__client():
    """
    Tests whether ``get_user_settings_preferred_client`` works as intended.
    ...
    mocked = vampytest.mock_globals(get_user_settings_preferred_client, 2, FEATURE_CLIENTS = FEATURE_CLIENTS)
...
def test__get_user_settings_preferred_client__no_match():
    """
    Tests whether ``get_user_settings_preferred_client`` works as intended.
    ...
    output = get_user_settings_preferred_client(event, 'mister')
