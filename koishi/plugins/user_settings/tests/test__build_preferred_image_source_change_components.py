...
from ..component_building import build_preferred_image_source_change_components
...
def test__build_preferred_image_source_change_components(option, value, changed):
    """
    Tests whether ``build_preferred_image_source_change_components`` works as intended.
    ...
    """
    output = build_preferred_image_source_change_components(option, value, changed)
