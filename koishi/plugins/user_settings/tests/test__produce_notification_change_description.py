...
from ..content_building import produce_notification_change_description
...
def test__produce_notification_change_description(option, value, changed):
    """
    Tests whether ``produce_notification_change_description`` works as intended.
    ...
    output : `str`
    """
    output = [*produce_notification_change_description(option, value, changed)]
