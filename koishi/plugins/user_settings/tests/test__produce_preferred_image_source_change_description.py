...
from ..content_building import produce_preferred_image_source_change_description
...
def test__produce_preferred_image_source_change_description(option, value, changed):
    """
    Tests whether ``produce_preferred_image_source_change_description`` works as intended.
    ...
    output : `str`
    """
    output = [*produce_preferred_image_source_change_description(option, value, changed)]
