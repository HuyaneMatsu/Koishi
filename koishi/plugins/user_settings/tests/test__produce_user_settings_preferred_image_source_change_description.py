...
from ..builders import produce_user_settings_preferred_image_source_change_description
...
def test__produce_user_settings_preferred_image_source_change_description(option, value, changed):
    """
    Tests whether ``produce_user_settings_preferred_image_source_change_description`` works as intended.
    ...
    output : `str`
    """
    output = [*produce_user_settings_preferred_image_source_change_description(option, value, changed)]
