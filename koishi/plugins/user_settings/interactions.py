...
async def handle_user_settings_notification_daily_by_waifu_enable(event):
    return await handle_user_settings_change(event, OPTION_NOTIFICATION_DAILY_BY_WAIFU, True)


@FEATURE_CLIENTS.interactions(custom_id = USER_SETTINGS_CUSTOM_ID_NOTIFICATION_DAILY_BY_WAIFU_DISABLE)
async def handle_user_settings_notification_daily_by_waifu_disable(event):
    return await handle_user_settings_change(event, OPTION_NOTIFICATION_DAILY_BY_WAIFU, False)


@FEATURE_CLIENTS.interactions(custom_id = USER_SETTINGS_CUSTOM_ID_NOTIFICATION_DAILY_REMINDER_ENABLE)
async def handle_user_settings_notification_daily_reminder_enable(event):
    return await handle_user_settings_change(event, OPTION_NOTIFICATION_DAILY_REMINDER, True)


@FEATURE_CLIENTS.interactions(custom_id = USER_SETTINGS_CUSTOM_ID_NOTIFICATION_DAILY_REMINDER_DISABLE)
async def handle_user_settings_notification_daily_reminder_disable(event):
    return await handle_user_settings_change(event, OPTION_NOTIFICATION_DAILY_REMINDER, False)


@FEATURE_CLIENTS.interactions(custom_id = USER_SETTINGS_CUSTOM_ID_NOTIFICATION_GIFT_ENABLE)
async def handle_user_settings_notification_gift_enable(event):
    return await handle_user_settings_change(event, OPTION_NOTIFICATION_GIFT, True)


@FEATURE_CLIENTS.interactions(custom_id = USER_SETTINGS_CUSTOM_ID_NOTIFICATION_GIFT_DISABLE)
async def handle_user_settings_notification_gift_disable(event):
    return await handle_user_settings_change(event, OPTION_NOTIFICATION_GIFT, False)


@FEATURE_CLIENTS.interactions(custom_id = USER_SETTINGS_CUSTOM_ID_NOTIFICATION_PROPOSAL_ENABLE)
async def handle_user_settings_notification_proposal_enable(event):
    return await handle_user_settings_change(event, OPTION_NOTIFICATION_PROPOSAL, True)
