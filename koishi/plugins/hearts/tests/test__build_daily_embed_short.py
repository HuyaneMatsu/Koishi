...
def test__build_daily_embed_short(interaction_event, target_user, total, streak, ready_to_claim):
    """
    ...
    output : ``Embed``
    """
    output = build_daily_embed_short(interaction_event, target_user, total, streak, ready_to_claim)
