...
def test__produce_stat_upgrade_confirmation_description(
    stat_housewife,
    stat_cuteness,
    stat_bedroom,
    stat_charm,
    ...
    """
    Tests whether ``produce_stat_upgrade_confirmation_description`` works as intended..
    ...
    output : `str`
    """
    output = [*produce_stat_upgrade_confirmation_description(
        stat_housewife,
        stat_cuteness,
        stat_bedroom,
        stat_charm,
