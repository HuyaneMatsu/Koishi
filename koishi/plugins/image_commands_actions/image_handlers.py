...
IMAGE_HANDLER_PAT = ImageHandlerGroup(
    ...
    ImageHandlerStatic(TOUHOU_ACTION_PAT, PREFERRED_IMAGE_SOURCE_TOUHOU),
)
IMAGE_HANDLER_KISS = ImageHandlerGroup(
    ImageHandlerWaifuPics('kiss', False),
    ImageHandlerStatic(TOUHOU_ACTION_KISS, PREFERRED_IMAGE_SOURCE_TOUHOU),
)
IMAGE_HANDLER_HUG = ImageHandlerGroup(
    ImageHandlerWaifuPics('hug', False),
    ImageHandlerStatic(TOUHOU_ACTION_HUG, PREFERRED_IMAGE_SOURCE_TOUHOU),
)
...
IMAGE_HANDLER_LICK = ImageHandlerGroup(
    ...
    ImageHandlerStatic(TOUHOU_ACTION_LICK, PREFERRED_IMAGE_SOURCE_TOUHOU),
)
...
IMAGE_HANDLER_FEED = ImageHandlerStatic(TOUHOU_ACTION_FEED, PREFERRED_IMAGE_SOURCE_TOUHOU)
IMAGE_HANDLER_FLUFF = ImageHandlerStatic(TOUHOU_ACTION_FLUFF, PREFERRED_IMAGE_SOURCE_TOUHOU)
IMAGE_HANDLER_POCKY = ImageHandlerStatic(TOUHOU_ACTION_POCKY_KISS, PREFERRED_IMAGE_SOURCE_TOUHOU)
IMAGE_HANDLER_POCKY_SELF = ImageHandlerStatic(TOUHOU_ACTION_POCKY_KISS_SELF, PREFERRED_IMAGE_SOURCE_TOUHOU)
IMAGE_HANDLER_LIKE = ImageHandlerStatic(TOUHOU_ACTION_LIKE, PREFERRED_IMAGE_SOURCE_TOUHOU)
IMAGE_HANDLER_KON = ImageHandlerStatic(TOUHOU_ACTION_KON, PREFERRED_IMAGE_SOURCE_TOUHOU)
