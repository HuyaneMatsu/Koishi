...
from .asset_listings import (
    TOUHOU_ACTION_FEED, TOUHOU_ACTION_FLUFF, TOUHOU_ACTION_HANDHOLD, TOUHOU_ACTION_HUG, TOUHOU_ACTION_KISS,
    TOUHOU_ACTION_KON, TOUHOU_ACTION_LAP_SLEEP, TOUHOU_ACTION_LICK, TOUHOU_ACTION_LIKE, TOUHOU_ACTION_PAT,
    TOUHOU_ACTION_PEG, TOUHOU_ACTION_POCKY_KISS, TOUHOU_ACTION_POCKY_KISS_SELF, TOUHOU_ACTION_STARE
)
...
IMAGE_HANDLER_HANDHOLD = ImageHandlerGroup(
    ImageHandlerWaifuPics('handhold', True),
    TOUHOU_ACTION_HANDHOLD,
)
