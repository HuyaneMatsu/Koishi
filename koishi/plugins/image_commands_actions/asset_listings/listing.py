...
from .constants import (
    ...
    ACTION_TAG_LIKE, ACTION_TAG_NOM, ACTION_TAG_PAT, ACTION_TAG_POCKY_KISS, ACTION_TAG_POCKY_KISS_SELF, ACTION_TAG_POKE,
    ACTION_TAG_STARE, ACTION_TAG_TICKLE, ACTION_TAG_WAVE
)
