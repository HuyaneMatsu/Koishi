...
from ..rendering import build_gamble_after_embed
...
def _iter_options():
    ...
    yield(
        ...
        1000,
        Embed(
            f'Gambled {1000!s} {EMOJI__HEART_CURRENCY}',
...
def test__build_gamble_after_embed(hand, amount):
    """
    Tests whether ``build_gamble_after_embed`` works as intended.
    ...
    output : ``Embed``
    """
    output = build_gamble_after_embed(hand, amount)
