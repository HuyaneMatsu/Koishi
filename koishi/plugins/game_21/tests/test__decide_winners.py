...
def _iter_options():
    player_0 = Player(User.precreate(202408040015), -1, InteractionEvent.precreate(202408040016))
    player_0.state = PLAYER_STATE_FINISH
    player_0.hand.add_card(8)
    player_0.hand.add_card(8)
    
    player_1 = Player(User.precreate(202408040017), -1, InteractionEvent.precreate(202408040018))
    player_1.state = PLAYER_STATE_FINISH
    player_1.hand.add_card(8)
    player_1.hand.add_card(8)
    
    player_2 = Player(User.precreate(202408040019), -1, InteractionEvent.precreate(202408040020))
    player_2.state = PLAYER_STATE_FINISH
    player_2.hand.add_card(8)
    player_2.hand.add_card(6)
    
    player_3 = Player(User.precreate(202408040021), -1, InteractionEvent.precreate(202408040022))
    player_3.state = PLAYER_STATE_FINISH
    player_3.hand.add_card(8)
    player_3.hand.add_card(6)
    player_3.hand.add_card(4)
    
    player_4 = Player(User.precreate(202408040023), -1, InteractionEvent.precreate(202408040024))
    player_4.state = PLAYER_STATE_FINISH
    player_4.hand.add_card(8)
    player_4.hand.add_card(6)
    player_4.hand.add_card(4)
    
    player_5 = Player(User.precreate(202408040024), -1, InteractionEvent.precreate(202408040025))
