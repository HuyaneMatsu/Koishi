...
from ...relationships_core import (
    RELATIONSHIP_TYPE_DAUGHTER, RELATIONSHIP_TYPE_MAMA, RELATIONSHIP_TYPE_WAIFU, Relationship
)

from ..checks import async_check_target_already_has_mama


def _iter_options():
    user_id_0 = 202501040030
    user_id_1 = 202501040031
    user_id_2 = 202501040032
    ...
    yield (
        ...
        [
            create_text_display(
                'Koishi\'s mama is Alice, therefore you cannot adopt them.'
            ),
        ],
    )
    ...
    yield (
        RELATIONSHIP_TYPE_MAMA,
        [
            Relationship(user_id_1, user_id_2, RELATIONSHIP_TYPE_DAUGHTER, 500, now),
        ],
        True,
        user_1,
        0,
    ...
    yield (
        ...
        [
            create_text_display(
                'Your mama is Alice, therefore you cannot adopt them.'
            ),
        ],
    )
...
async def test__async_check_target_already_has_mama(
    relationship_type,
    ...
    """
    Tests whether ``async_check_target_already_has_mama`` works as intended.
    ...
    mocked = vampytest.mock_globals(
        async_check_target_already_has_mama,
