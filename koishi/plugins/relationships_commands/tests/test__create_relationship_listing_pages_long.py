...
from ...relationships_core import (
    ...
    RELATIONSHIP_TYPE_CONNECTION_MODIFIER_TYPE_IN_LAW, RELATIONSHIP_TYPE_CO_WORKER, RELATIONSHIP_TYPE_DAUGHTER,
    ...
    Relationship, RelationshipExtensionTrace, RELATIONSHIP_TYPE_CONNECTION_MODIFIER_TYPE_NONE
)

from ..relationship_listing_rendering_long import create_relationship_listing_pages_long


def _iter_options():
    user_id_00 = 202601250100
    user_id_01 = 202601250101
    user_id_02 = 202601250102
    user_id_03 = 202601250103
    user_id_04 = 202601250104
    user_id_05 = 202601250105
    user_id_06 = 202601250106
    user_id_07 = 202601250107
    user_id_08 = 202601250108
    user_id_09 = 202601250109
    user_id_10 = 202601250110
    user_id_11 = 202601250111
    user_id_12 = 202601250112
...
def test__create_relationship_listing_pages_long(relationship_extension_traces, users, guild_id):
    """
    Tests whether ``create_relationship_listing_pages_long`` works as intended.
    ...
    Returns
    -------
    output : `None | list<list<(int, int, list<str>)>>`
    """
    output = create_relationship_listing_pages_long(relationship_extension_traces, users, guild_id)
