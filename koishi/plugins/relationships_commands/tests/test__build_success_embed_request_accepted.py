...
from ..embed_builders import build_success_embed_request_accepted
...
def test__build_success_embed_request_accepted(relationship_type, investment, source_user, guild_id):
    """
    Tests whether ``build_success_embed_request_accepted`` works as intended.
    ...
    output : ``Embed``
    """
    output = build_success_embed_request_accepted(relationship_type, investment, source_user, guild_id)
