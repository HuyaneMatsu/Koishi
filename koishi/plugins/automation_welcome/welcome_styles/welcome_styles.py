...
from .nue import WELCOME_STYLE as WELCOME_STYLE_NUE


WELCOME_STYLES_BY_NAME = {
    WELCOME_STYLE_FLANDRE.name: WELCOME_STYLE_FLANDRE,
    WELCOME_STYLE_KOISHI.name: WELCOME_STYLE_KOISHI,
    WELCOME_STYLE_NUE.name: WELCOME_STYLE_NUE,
}


WELCOME_STYLES_BY_CLIENT_ID = {
    WELCOME_STYLE_FLANDRE.client_id: WELCOME_STYLE_FLANDRE,
    WELCOME_STYLE_KOISHI.client_id: WELCOME_STYLE_KOISHI,
    WELCOME_STYLE_NUE.client_id: WELCOME_STYLE_NUE,
}
