...
from ..chart import get_user_stats_chart_url


def _iter_options():
    user_stats = UserStats(202503120010)
    user_stats.stat_housewife = 5
    user_stats.stat_cuteness = 6
    user_stats.stat_bedroom = 7
    user_stats.stat_charm = 8
    user_stats.stat_loyalty = 9
...
def test__get_user_stats_chart_url(user_stats, color):
    """
    Tests whether ``get_user_stats_chart_url`` works as intended.
    ...
    """
    url = get_user_stats_chart_url(user_stats, color)
