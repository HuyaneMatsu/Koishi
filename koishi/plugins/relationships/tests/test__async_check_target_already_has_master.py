...
from ..checks import async_check_target_already_has_master
from ..relationship import Relationship
from ..relationship_types import (
    RELATIONSHIP_TYPE_MAID, RELATIONSHIP_TYPE_MAMA, RELATIONSHIP_TYPE_MASTER, RELATIONSHIP_TYPE_WAIFU
)
...
def _iter_options__failing():
    ...
    yield (
        RELATIONSHIP_TYPE_MASTER,
        [
            Relationship(user_id_1, user_id_2, RELATIONSHIP_TYPE_MASTER, 500, now),
        ],
        True,
        user_0,
        user_1,
    ...
    yield (
        RELATIONSHIP_TYPE_MASTER,
        [
            Relationship(user_id_2, user_id_1, RELATIONSHIP_TYPE_MAID, 500, now),
        ],
        True,
        user_0,
        user_1,
...
async def test__async_check_target_already_has_master(
    relationship_type,
    ...
    """
    Tests whether ``async_check_target_already_has_master`` works as intended.
    ...
    mocked = vampytest.mock_globals(
        async_check_target_already_has_master,
