...
from ..relationship_completion import get_relationship_user_names_like_at
...
async def test__get_relationship_user_names_like_at(user_id, value, guild_id, relationships, users):
    """
    Tests whether ``get_relationship_user_names_like_at`` works as intended.
    ...
    mocked = vampytest.mock_globals(
        get_relationship_user_names_like_at,
