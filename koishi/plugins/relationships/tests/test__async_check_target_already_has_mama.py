...
from ..relationship_types import RELATIONSHIP_TYPE_DAUGHTER, RELATIONSHIP_TYPE_MAMA, RELATIONSHIP_TYPE_WAIFU
...
def _iter_options__failing():
    user_id_0 = 202501040033
    user_id_1 = 202501040034
    user_id_2 = 202501040035
    ...
    yield (
        RELATIONSHIP_TYPE_MAMA,
        [
            Relationship(user_id_2, user_id_1, RELATIONSHIP_TYPE_DAUGHTER, 500, now),
        ],
        True,
        user_0,
        user_1,
