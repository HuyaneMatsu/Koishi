    ...
    return InteractionResponse(
        ...
        embed = Embed(
            ...
            (
                ...
                f'emoji of your choice, like {EXAMPLE_EMOJI} .\n'
                f'\n'
                ...
                f'{name!s} has to be configured whether should look for emojis in names or in topics and what '
                f'kind of emojis (unicode or custom) it should look there.'
                f'\n'
                f'The user needs **manage messages** permission to invoke this command in both channels while {name!s} '
