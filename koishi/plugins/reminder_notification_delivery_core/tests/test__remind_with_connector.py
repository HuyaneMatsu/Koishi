...
from ..reminding import remind_with_connector


async def test__remind_with_connector__default():
    """
    Tests whether ``remind_with_connector`` works as intended.
    ...
    async def notifier(input_entry, input_connector):
        nonlocal connector
        nonlocal entries
