    ...
    async def _insert_entry(self, connector, entry_proxy):
        response = await connector.execute(
            USER_BALANCE_TABLE.insert().values(
                ...
                count_daily_by_waifu = entry_proxy.count_daily_by_waifu,
                count_daily_for_waifu = entry_proxy.count_daily_for_waifu,
                ...
                waifu_cost = entry_proxy.waifu_cost,
                waifu_divorces = entry_proxy.waifu_divorces,
                waifu_slots = entry_proxy.waifu_slots,
                waifu_owner_id = entry_proxy.waifu_owner_id,
            ).returning(
